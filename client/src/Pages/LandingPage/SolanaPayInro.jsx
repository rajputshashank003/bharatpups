...
const SolanaPayInro = () => {
    ...
    return (
        <div className="relative solanaLogo1_par flex h-screen w-screen lg:w-full">
            <div className="flex absolute -left-8 md:-left-10 justify-center items-center  h-screen w-screen lg:w-full">
                <div data-scroll-container className='h-screen max-sm:hidden absolute -left-8 md:-left-10 top-0 w-screen lg:w-full'>
                ...
                <div className='relative backdrop-blur-sm w-screen lg:w-full flex justify-center items-center '>
                    <img className='w-[40rem] sm:h-[20rem] max-sm:w-[16rem] solanaLogo1' src="/solanaLogo1.svg" alt="" />
                </div>

            </div>
            <div style={{ fontFamily: "oddo, sans-serif" }} className='max-md:text-[28px] text-xl text-center backdrop-blur-sm absolute max-sm:-left-6 px-2 -left-8 bottom-32 flex flex-wrap text-black justify-center items-center w-full'>
                Pay food bills using Solana's fast and secure blockchain technology.
                <br />
                Experience the future of payments today.
            </div>
            <div className="absolute bottom-10 w-screen lg:w-full flex justify-center items-center">
