    ...
    useGSAP(() => {
        ...
        gsap.to(".stfm2a", {
            ...
            scrollTrigger: {
                ...
                scrub : 2,
                start: "top 0%",
                end: `top -${32 * scrollSpeedDecreaseBy}%`,
            }
        });
        ...
        gsap.to(".moving_img0", {
            ...
            scrollTrigger: {
                trigger: ".stfm1",
                start: `top -${0 * scrollSpeedDecreaseBy}%`,
                end: `top -${56 * scrollSpeedDecreaseBy}%`,
                scrub: 2,
            },
        });
        // gsap.to(".moving_img1", {
        ...
        gsap.to(".moving_img3", {
            ...
            scrollTrigger: {
                trigger: ".stfm1",
                start: `top -${56 * scrollSpeedDecreaseBy}%`,
                end: `top -${90 * scrollSpeedDecreaseBy}%`,
                scrub: 2,
            },
        });
        ...
        const colorChangeTarget = ".main_file" ;
